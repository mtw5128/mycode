...
def get_ip_data():
    ...
    input_test1 = input("Which column is this?")
    input_test2 = input("Is this the 4th column?")
    #d = {"IP": input_ip, "driver": input_driver, "Column 3": input_test1, "Yes/No": input_test2}
